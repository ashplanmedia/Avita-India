...
<section class="promo-banner mt-1">
    ...
    <section class="email-subscription py-5 ls-0">
        <form class="email-subscription-form col-12 col-lg-8 col-xl-6 mx-auto">
            ...
            <p style="text-align: center;"><a href="/Avita-Brochure.pdf" target="_blank" download="/AVITA-U-SERIES-Brochure.pdf"><button class="btn btn-primary btn-lg " type="button">Download Brochure </button></a></p>
