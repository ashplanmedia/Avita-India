    ...
    <div class="container">
        ...
        <div class="product-nav-collapse">
            <ul class="nav-product d-flex list-unstyled flex-column justify-content-center text-center flex-sm-row justify-content-sm-end my-2">  
                <li class="nav-item"><a class="nav-link py-1" href="http://localhost:8000/customMagus">Magus</a></li>
                <li class="nav-item"><a class="nav-link py-1" href="http://localhost:8000/customUSeries">U Series</a></li>
                <li class="nav-item"> <a class="nav-link py-1" href="http://localhost:8000/customVSeries">V series</a>
                    </li>
    ...
    <div class="col-md-8 text-center">
     ...
     <div id="carousel" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            <div class="item active"> <img id="1a" height="500px" width="500px" style="margin-left:200px" src="images/custom/U Series/Angel Blue/MAIN.jpg"> </div>
            <div class="item"> <img id="2a" height="500px"  width="500px" style="margin-left:200px;margin-top:70px;" src= "images/custom/U Series/Angel Blue/PTO1.jpg"> </div>
            <div class="item"> <img id="3a" height="500px" width="500px" style="margin-left:200px;margin-top:70px;" src= "images/custom/U Series/Angel Blue/PTO2.jpg"> </div>
            <div class="item"> <img id="4a" height="500px" width="500px" style="margin-left:200px;margin-top:70px;"  src= "images/custom/U Series/Angel Blue/PTO3.jpg"> </div>
            <div class="item"> <img id="5a" height="500px" width="500px" style="margin-left:200px;margin-top:70px;" src= "images/custom/U Series/Angel Blue/PTO4.jpg"> </div>
            <div class="item"> <img id="6a" height="500px" width="500px" style="margin-left:200px;margin-top:70px;" src= "images/custom/U Series/Angel Blue/PTO5.jpg"> </div>
            <div class="item"> <img id="7a" height="500px" width="500px" style="margin-left:200px;margin-top:70px;" src= "images/custom/U Series/Angel Blue/PTO6.jpg"> </div>
            <div class="item"> <img id="8a" height="500px" width="500px" style="margin-left:200px;margin-top:70px;" src= "images/custom/U Series/Angel Blue/PTO7.jpg"> </div>
            <div class="item"> <img id="9a" height="500px" width="500px" style="margin-left:200px;margin-top:70px;" src= "images/custom/U Series/Angel Blue/PTO8.jpg"> </div>
          </div>
        </div>
