...
$productTypeField.on('init', function() {
    ...
    var url = "https://asp.avita.global/api/product/types?country=IN";
...
$productTypeField.change(function() {
    ...
    if ( $(this).val() ) {
        ...
        var url = "https://asp.avita.global/api/product/series?country=IN";
...
$productSeriesField.change(function() {
    ...
    if ( $(this).val() ) {
        var url = "https://asp.avita.global/api/products/marketing_numbers?country=IN";
...
$marketingNumberField.change(function() {
    ...
    if ( $(this).val() ) {
        var url = "https://asp.avita.global/api/products/models?country=IN";
